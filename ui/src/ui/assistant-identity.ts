...
declare global {
  interface Window {
    __XCRIMINAL_ASSISTANT_NAME__?: string;
    __XCRIMINAL_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__XCRIMINAL_ASSISTANT_NAME__,
    avatar: window.__XCRIMINAL_ASSISTANT_AVATAR__,
  });
}
