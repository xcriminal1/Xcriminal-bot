...
import { XcriminalApp } from "./app";
import "../styles.css";

const originalConnect = XcriminalApp.prototype.connect;

function mountApp(pathname: string) {
  window.history.replaceState({}, "", pathname);
  const app = document.createElement("moltbot-app") as XcriminalApp;
...
beforeEach(() => {
  XcriminalApp.prototype.connect = () => {
...
afterEach(() => {
  XcriminalApp.prototype.connect = originalConnect;
  window.__CLAWDBOT_CONTROL_UI_BASE_PATH__ = undefined;
  localStorage.clear();
  document.body.innerHTML = "";
});
