...
- Install via CLI: `Xcriminal plugins install @Xcriminal/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `Xcriminal plugins install ./extensions/zalo`
   - From npm (if published): `Xcriminal plugins install @Xcriminal/zalo`
...
- Approve via:
  - `Xcriminal pairing list zalo`
  - `Xcriminal pairing approve zalo <CODE>`
...
- Example: `Xcriminal message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `Xcriminal channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `Xcriminal logs --follow`
