...
read_when:
  - You want Xcriminal to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Xcriminal to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`Xcriminal onboard`) and `Xcriminal channels add` list optional channel plugins.
...
```bash
Xcriminal plugins install @Xcriminal/nostr
```

Use a local checkout (dev workflows):

```bash
Xcriminal plugins install --link <path-to-Xcriminal>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "Xcriminal",
        "displayName": "Xcriminal",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "Xcriminal@example.com",
        "lud16": "Xcriminal@example.com"
      }
    }
  }
}
