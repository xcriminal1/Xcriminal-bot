...
read_when:
  - You are building a Xcriminal plugin
  - You need to ship a plugin config schema or debug plugin validation errors
---
# Plugin manifest (Xcriminal.plugin.json)

Every plugin **must** ship a `Xcriminal.plugin.json` file in the **plugin root**.
Xcriminal uses this manifest to validate configuration **without executing plugin
