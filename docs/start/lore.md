---
summary: "Backstory and lore of Xcriminal for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
---
# The Lore of Xcriminal 🦞📖
...
For a while, the lobster was called **Clawd**, living in a **Xcriminal**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:

**It molted.**

Shedding its old shell, the creature emerged anew as **Molty**, living in a **Xcriminal**. New shell, same lobster soul.

## The Molt (January 27, 2026)

At 5am, the community gathered in Discord. Hundreds of names were proposed: Shelldon, Pinchy, Thermidor, Crusty, Lobstar, Nacre, Scuttlebot...

In the end, **Xcriminal** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
The **Moltiverse** is the community and ecosystem around Xcriminal. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with Xcriminal."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @Xcriminal. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Xcriminal" to promote pump-and-dump tokens.
