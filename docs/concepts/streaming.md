...
Xcriminal has two separate “streaming” layers:
...
When block streaming is enabled, Xcriminal can **merge consecutive block chunks**
...
When draft streaming is active, Xcriminal disables block streaming for that reply to avoid double-streaming.
