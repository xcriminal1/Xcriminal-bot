...
This page ties together how Xcriminal handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Xcriminal keeps a
...
Xcriminal separates the **prompt body** from the **command body**:
...
Xcriminal can expose or hide model reasoning:
