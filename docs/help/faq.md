---
summary: "Frequently asked questions about Xcriminal setup, configuration, and usage"
---
# FAQ
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up Xcriminal?](#whats-the-recommended-way-to-install-and-set-up-Xcriminal)
  ...
  - [I can't access docs.molt.bot (SSL error). What now?](#i-cant-access-docsXcriminal-ssl-error-what-now)
  - [What’s the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or Xcriminal not recognized](#windows-install-says-git-not-found-or-Xcriminal-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Xcriminal on Linux?](#how-do-i-install-Xcriminal-on-linux)
  - [How do I install Xcriminal on a VPS?](#how-do-i-install-Xcriminal-on-a-vps)
  ...
  - [If I buy a Mac mini to run Xcriminal, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-Xcriminal-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Xcriminals?](#can-multiple-people-use-one-whatsapp-number-with-different-Xcriminals)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Xcriminal on a dedicated machine?](#how-important-is-it-to-run-Xcriminal-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Xcriminal in a VM and what are the requirements](#can-i-run-Xcriminal-in-a-vm-and-what-are-the-requirements)
- [What is Xcriminal?](#what-is-Xcriminal)
  - [What is Xcriminal, in one paragraph?](#what-is-Xcriminal-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Xcriminal](#what-are-the-top-five-everyday-use-cases-for-Xcriminal)
  - [Can Xcriminal help with lead gen outreach ads and blogs for a SaaS](#can-Xcriminal-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Xcriminal run tasks on a schedule or continuously in the background?](#can-Xcriminal-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Xcriminal saved locally?](#is-all-data-used-with-Xcriminal-saved-locally)
  - [Where does Xcriminal store its data?](#where-does-Xcriminal-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Xcriminal?](#how-do-i-completely-uninstall-Xcriminal)
...
- [Config basics](#config-basics)
  ...
  - [Can the Xcriminal browser run headless?](#can-the-Xcriminal-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two Xcriminals talk to each other (local + VPS)?](#can-two-Xcriminals-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Xcriminal load environment variables?](#how-does-Xcriminal-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of Xcriminals one CEO and many agents](#is-there-a-way-to-make-a-team-of-Xcriminals-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Xcriminal but keep it installed?](#how-do-i-completely-reset-Xcriminal-but-keep-it-installed)
  ...
  - [Why doesn’t Xcriminal reply in a group?](#why-doesnt-Xcriminal-reply-in-a-group)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `Xcriminal gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-Xcriminal-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `Xcriminal gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-Xcriminal-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Xcriminal in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-Xcriminal-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Xcriminal?](#i-closed-my-terminal-on-windows-how-do-i-restart-Xcriminal)
  ...
  - [ELI5: `Xcriminal gateway restart` vs `Xcriminal gateway`](#eli5-Xcriminal-gateway-restart-vs-Xcriminal-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Xcriminal to inbound DMs?](#is-it-safe-to-expose-Xcriminal-to-inbound-dms)
...
5) **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/Xcriminal/Xcriminal-*.log | head -1)"
   ```
...
7) **Gateway snapshot**
   ...
   Xcriminal health --verbose   # shows the target URL + config path on errors
   ```
...
This installs Xcriminal **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/Xcriminal/Xcriminal/issues
https://github.com/Xcriminal/Xcriminal/pulls
...
What they do:
- `Xcriminal status`: quick snapshot of gateway/agent health + basic config.
- `Xcriminal models status`: checks provider auth + model availability.
- `Xcriminal doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `Xcriminal status --all`, `Xcriminal logs --follow`,
`Xcriminal gateway status`, `Xcriminal health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### Whats the recommended way to install and set up Xcriminal
...
If you don’t have a global install yet, run it via `pnpm Xcriminal onboard`.
...
- If it asks for auth, run `Xcriminal dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `Xcriminal_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**
- **Tailscale Serve** (recommended): keep bind loopback, run `Xcriminal gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `Xcriminal gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `Xcriminal dashboard`.
...
1) Install Xcriminal on the new machine.
2) Copy `$Xcriminal_STATE_DIR` (default: `~/.Xcriminal`) from the old machine.
3) Copy your workspace (default: `~/clawd`).
4) Run `Xcriminal doctor` and restart the Gateway service.
...
under `~/.Xcriminal/` (for example `~/.Xcriminal/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-Xcriminal-store-its-data),
...
https://github.com/Xcriminal/Xcriminal/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docsXcriminal SSL error What now
...
detail: [Troubleshooting](/help/troubleshooting#docsXcriminal-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/Xcriminal/Xcriminal/tree/main/docs
...
### Windows install says git not found or Xcriminal not recognized
...
**2) Xcriminal is not recognized after install**
...
### How do I install Xcriminal on Linux
...
### How do I install Xcriminal on a VPS
...
```bash
Xcriminal update
Xcriminal update status
Xcriminal update --channel stable|beta|dev
Xcriminal update --tag <dist-tag|version>
Xcriminal update --no-restart
```

If you must automate from an agent:

```bash
Xcriminal update --yes --no-restart
Xcriminal gateway restart
```
...
`Xcriminal onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Xcriminal with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `Xcriminal models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `Xcriminal models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `Xcriminal models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. Xcriminal no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Xcriminal can keep replying while a provider is rate‑limited.
...
Xcriminal supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Xcriminal fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `Xcriminal.json`.

Steps:
1) Enable the plugin: `Xcriminal plugins enable google-gemini-cli-auth`
2) Login: `Xcriminal models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Xcriminal needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Xcriminal runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. Xcriminal’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run Xcriminal can I connect it to my MacBook Pro
...
- Use `Xcriminal nodes status` / `Xcriminal nodes list` to see it.
...
- DM your bot, then run `Xcriminal logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Xcriminals
...
If you run Xcriminal via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
This **does not delete your data** - it only changes the Xcriminal code install. Your state
(`~/.Xcriminal`) and workspace (`~/clawd`) stay untouched.
...
**Xcriminal-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Xcriminal on a dedicated machine
...
Xcriminal is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Xcriminal in a VM and what are the requirements
...
### What is Xcriminal in one paragraph

Xcriminal is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### Whats the value proposition

Xcriminal is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Xcriminal
...
### Can Xcriminal help with lead gen outreach ads and blogs for a SaaS
...
Xcriminal draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Xcriminal is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Xcriminal when you
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.Xcriminal/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.Xcriminal/Xcriminal.json`). Precedence is `<workspace>/skills` > `~/.Xcriminal/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.Xcriminal/Xcriminal.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.Xcriminal/skills` → bundled → `skills.load.extraDirs`. `clawdhub` installs into `./skills` by default, which Xcriminal treats as `<workspace>/skills`.
...
Checklist:
- Confirm cron is enabled (`cron.enabled`) and `Xcriminal_SKIP_CRON` is not set.
- Check the Gateway is running 24/7 (no sleep/restarts).
- Verify timezone settings for the job (`--tz` vs host timezone).

Debug:
```bash
Xcriminal cron run <jobId> --force
Xcriminal cron runs --id <jobId> --limit 50
```
...
### Can Xcriminal run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.Xcriminal.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-Xcriminal-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Xcriminal can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3) Override the skill metadata (workspace or `~/.Xcriminal/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: {"Xcriminal":{"os":["darwin","linux"],"requires":{"bins":["imsg"]}}}
   ---
   ```
4) Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (Xcriminal only needs stdio). See [iMessage](/channels/imessage).
...
ClawdHub installs into `./skills` under your current directory (or falls back to your configured Xcriminal workspace); Xcriminal treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.Xcriminal/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawdHub](/tools/clawdhub).
...
Xcriminal memory is just Markdown files in the agent workspace:
- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Xcriminal also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, Xcriminal auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Xcriminal
prefers `local`.
...
### Is all data used with Xcriminal saved locally

No - **Xcriminal’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.Xcriminal` + your workspace directory).
...
### Where does Xcriminal store its data

Everything lives under `$Xcriminal_STATE_DIR` (default: `~/.Xcriminal`):

| Path | Purpose |
|------|---------|
| `$Xcriminal_STATE_DIR/Xcriminal.json` | Main config (JSON5) |
| `$Xcriminal_STATE_DIR/credentials/oauth.json` | Legacy OAuth import (copied into auth profiles on first use) |
| `$Xcriminal_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys) |
| `$Xcriminal_STATE_DIR/agents/<agentId>/agent/auth.json` | Runtime auth cache (managed automatically) |
| `$Xcriminal_STATE_DIR/credentials/` | Provider state (e.g. `whatsapp/<accountId>/creds.json`) |
| `$Xcriminal_STATE_DIR/agents/` | Per‑agent state (agentDir + sessions) |
| `$Xcriminal_STATE_DIR/agents/<agentId>/sessions/` | Conversation history & state (per agent) |
| `$Xcriminal_STATE_DIR/agents/<agentId>/sessions/sessions.json` | Session metadata (per agent) |

Legacy single‑agent path: `~/.Xcriminal/agent/*` (migrated by `Xcriminal doctor`).
...
These files live in the **agent workspace**, not `~/.Xcriminal`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.Xcriminal`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.Xcriminal/skills`).
...
Do **not** commit anything under `~/.Xcriminal` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Xcriminal
...
`workspace` to the repo root. The Xcriminal repo is just source code; keep the
...
Xcriminal reads an optional **JSON5** config from `$Xcriminal_CONFIG_PATH` (default: `~/.Xcriminal/Xcriminal.json`):

```
$Xcriminal_CONFIG_PATH
```
...
Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `Xcriminal_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `Xcriminal doctor --generate-gateway-token`.
...
key. **Recommended:** run `Xcriminal configure --section web` to store it in
...
- Daemons read env vars from `~/.Xcriminal/.env` (or the service environment).
...
### Can the Xcriminal browser run headless
...
Check the basics:
- Gateway is running: `Xcriminal gateway status`
- Gateway health: `Xcriminal status`
- Channel health: `Xcriminal channels status`
...
### Can two Xcriminals talk to each other local VPS
...
`Xcriminal agent --message ... --deliver`, targeting a chat where the other bot
listens. If one bot is on a remote VPS, point your CLI at that remote Gateway
via SSH/Tailscale (see [Remote access](/gateway/remote)).

Example pattern (run from a machine that can reach the target Gateway):
```bash
Xcriminal agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
Recover:
- Restore from backup (git or a copied `~/.Xcriminal/Xcriminal.json`).
- If you have no backup, re-run `Xcriminal doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:
- Use `Xcriminal config set` for small changes.
- Use `Xcriminal configure` for interactive edits.
...
```bash
Xcriminal gateway --tailscale serve
```
...
### How does Xcriminal load environment variables

Xcriminal reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.Xcriminal/.env` (aka `$Xcriminal_STATE_DIR/.env`)
...
1) Put the missing keys in `~/.Xcriminal/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`Xcriminal_LOAD_SHELL_ENV=1`, `Xcriminal_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`Xcriminal models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means Xcriminal won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1) Put the token in `~/.Xcriminal/.env`:
   ```
...
### Is there a way to make a team of Xcriminals one CEO and many agents
...
### How do I completely reset Xcriminal but keep it installed
...
```bash
Xcriminal reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `Xcriminal_PROFILE`), reset each state dir (defaults are `~/.Xcriminal-<profile>`).
- Dev reset: `Xcriminal gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Xcriminal skips the heartbeat run to save API calls.
...
No. Xcriminal runs on **your own account**, so if you’re in the group, Xcriminal can see it.
...
```bash
Xcriminal directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt Xcriminal reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.Xcriminal/agents/<agentId>/sessions/`.
...
- Use `Xcriminal doctor` to spot stray workspaces and profile mismatches.
...
Xcriminal’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, Xcriminal currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `Xcriminal models set ...` (updates just model config)
- `Xcriminal configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.Xcriminal/Xcriminal.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `Xcriminal doctor` to repair.
...
Yes. Xcriminal ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.Xcriminal/agents/<agentId>/agent/auth-profiles.json
```

Fix options:
- Run `Xcriminal agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Xcriminal can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.Xcriminal/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.Xcriminal/agent/*` (migrated by `Xcriminal doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.Xcriminal/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `Xcriminal models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `Xcriminal models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `Xcriminal models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.Xcriminal/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    Xcriminal models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Xcriminal will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: Xcriminal now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Xcriminal uses provider‑prefixed IDs like:
...
Xcriminal may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `Xcriminal models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent’s `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
Xcriminal models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
Xcriminal models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
Xcriminal models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
Xcriminal models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

Xcriminal supports both:
...
```
--port > Xcriminal_GATEWAY_PORT > gateway.port > default 18789
```

### Why does Xcriminal gateway status say Runtime running but RPC probe failed

Because “running” is the **supervisor’s** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `Xcriminal gateway status` and trust these lines:
- `Probe target:` (the URL the probe actually used)
- `Listening:` (what’s actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn’t listening)

### Why does Xcriminal gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `Xcriminal_STATE_DIR` mismatch).

Fix:
```bash
Xcriminal gateway install --force
```
Run that from the same `--profile` / environment you want the service to use.

### What does another gateway instance is already listening mean

Xcriminal enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `Xcriminal gateway --port <port>`.

### How do I run Xcriminal in remote mode client connects to a Gateway elsewhere
...
Notes:
- `Xcriminal gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
Facts (from code):
- The Control UI stores the token in browser localStorage key `Xcriminal.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:
- Fastest: `Xcriminal dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `Xcriminal doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `Xcriminal_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `Xcriminal status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `Xcriminal_CONFIG_PATH` (per‑instance config)
- `Xcriminal_STATE_DIR` (per‑instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):
- Use `Xcriminal --profile <name> …` per instance (auto-creates `~/.Xcriminal-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `Xcriminal --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.Xcriminal.*`, `Xcriminal-gateway-<profile>.service`, `Xcriminal Gateway (<profile>)`).
...
```
Xcriminal tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/Xcriminal/Xcriminal-YYYY-MM-DD.log
```
...
- macOS: `$Xcriminal_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.Xcriminal/logs/...`; profiles use `~/.Xcriminal-<profile>/logs/...`)
- Linux: `journalctl --user -u Xcriminal-gateway[-<profile>].service -n 200 --no-pager`
...
If you run the gateway manually, `Xcriminal gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Xcriminal
...
1) Is the Gateway running? `Xcriminal gateway status`
2) Is the Gateway healthy? `Xcriminal status`
3) Does the UI have the right token? `Xcriminal dashboard`
...
```bash
Xcriminal channels status
Xcriminal channels logs --channel telegram
```
...
### ELI5 Xcriminal gateway restart vs Xcriminal gateway

- `Xcriminal gateway restart`: restarts the **background service** (launchd/systemd).
- `Xcriminal gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `Xcriminal gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Xcriminal assistant setup](/start/clawd) and [Agent send](/tools/agent-send).

CLI sending:

```bash
Xcriminal message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Xcriminal to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `Xcriminal pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `Xcriminal pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `Xcriminal doctor` to surface risky DM policies.
...
```bash
Xcriminal pairing list telegram
```
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Xcriminal only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
Xcriminal pairing approve whatsapp <code>
```

List pending requests:

```bash
Xcriminal pairing list whatsapp
```
...
Xcriminal blocks **cross‑provider** messaging by default. If a tool call is bound
...
**A:** In Xcriminal, credentials and model selection are separate. Setting `ANTHROPIC_API_KEY` (or storing an Anthropic API key in auth profiles) enables authentication, but the actual default model is whatever you configure in `agents.defaults.model.primary` (for example, `anthropic/claude-sonnet-4-5` or `anthropic/claude-opus-4-5`). If you see `No credentials found for profile "anthropic:default"`, it means the Gateway couldn’t find Anthropic credentials in the expected `auth-profiles.json` for the agent that’s running.

---

Still stuck? Ask in [Discord](https://discord.com/invite/clawd) or open a [GitHub discussion](https://github.com/Xcriminal/Xcriminal/discussions).
