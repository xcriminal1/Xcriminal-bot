...
You can also set `Xcriminal_VERBOSE=1` instead of the flag.
...
- Check the allowlist: `Xcriminal config get agents.defaults.models`
...
If you can, include the relevant log tail from `Xcriminal logs --follow`.
