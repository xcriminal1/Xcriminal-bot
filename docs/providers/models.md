---
summary: "Model providers (LLMs) supported by Xcriminal"
read_when:
...
Xcriminal can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `Xcriminal onboard`).
