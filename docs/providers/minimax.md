---
summary: "Use MiniMax M2.1 in Xcriminal"
read_when:
  - You want MiniMax models in Xcriminal
...
Configure manually via `Xcriminal.json`:
...
- Use `Xcriminal models list` and `Xcriminal models set minimax/MiniMax-M2.1` to switch.
...
- Running `Xcriminal configure` and selecting **MiniMax M2.1**, or
