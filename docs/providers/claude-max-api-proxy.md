...
You can point Xcriminal at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Xcriminal
...
- [Anthropic provider](/providers/anthropic) - Native Xcriminal integration with Claude setup-token or API keys
