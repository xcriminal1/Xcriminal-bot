---
summary: "Use Qwen OAuth (free tier) in Xcriminal"
read_when:
  - You want to use Qwen with Xcriminal
...
```bash
Xcriminal models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Xcriminal will sync credentials
