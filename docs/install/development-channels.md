...
Xcriminal ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Xcriminal also aligns
the install method:
...
When you switch channels with `Xcriminal update`, Xcriminal also syncs plugin sources:
