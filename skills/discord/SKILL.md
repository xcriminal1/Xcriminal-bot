...
Use `discord` to manage messages, reactions, threads, polls, and moderation. You can disable groups via `discord.actions.*` (defaults to enabled, except roles/moderation). The tool uses the bot token configured for Xcriminal.
...
```json
{
  ...
  "guildId": "999",
  "name": "Xcriminal_wave",
  "description": "Xcriminal waving hello",
  "tags": "👋",
